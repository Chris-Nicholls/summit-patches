...
parameters = {
    ...
    "Oscillator 1 Fine": CC_Pair(cc1=15, cc2=47, val_min=28, val_max=228, default_val=128),
    ...
    "Oscillator 2 Coarse": CC_Pair(cc1=17, cc2=49, val_min=0, val_max=255, default_val=64),
    "Oscillator 2 Fine": CC_Pair(cc1=18, cc2=50, val_min=28, val_max=228, default_val=64),
    ...
    "Oscillator 3 Fine": CC_Pair(cc1=21, cc2=53, val_min=28, val_max=228, default_val=128),
    ...
    "Effects Routing": NRPN(cc1=0, cc2=89, val_min=0, val_max=3, default_val=0),
